...
<h1 class="h2">Item Management Update</h1>

</div >
    <div class="row">
        <div class="col-md-12 order-md-1  ">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('item-mgmt.update', [$data->id]) }}" enctype="multipart/form-data">
