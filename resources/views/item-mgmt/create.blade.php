...
<div class="col-md-12 order-md-1  "  >
          <form class="needs-validation" role="form" method="POST" action="{{ route('item-mgmt.store') }}">
          {{ csrf_field() }}
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
              ...
              <a  href="{{ url('item-mgmt') }}"  class=" btn btn-primary" data-toggle="tooltip" data-placement="left" title="edit">Back</a>
              </div>
