...
<div class="col-md-12">
    ...
    <div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title">COnsumed Item
 </h3>
      </div>
                ...
                <div class="row ">
                    <div class="col-md-6 p-3 px-3 ">
                        <table class="table table-sm table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th >Qty Consumed</th>
                                        <td colspan="1">{{ $data->qty_consumed }}</td>
                                    </tr>
                                    <tr>
                                        <th >TBO</th>
                    ...
                    <div class="col-md-6 p-3 px-3">
                        ...
                        <div class="form-group">
                            ...
                            <a  href="{{ url('item-consume-mgmt') }}"  class=" btn btn-primary" data-toggle="tooltip" data-placement="left" title="edit">Back</a>
                            </div>
                        </div>
