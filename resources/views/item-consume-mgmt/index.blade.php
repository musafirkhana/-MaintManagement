@extends('item-consume-mgmt.base')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
      <div class="col-md-12">
          <div class="row">
                ...
                <div class="col-sm-6">
                <div class="form-group">
                <form class="form-horizontal" action="{{ route('item-consume-mgmt.search')}}" role="form" method="POST"  >
                {{ csrf_field() }}
                    <div class="row">
                        <div class="col-5"> 
                            <div class="form-group">
            ...
            @foreach ($datas as $data)
                <tr  >
                  ...
                  <td >
                          ...
                          <a   href="{{ route('item-consume-mgmt.show', [$data->id]) }}" class="btn btn-info" data-toggle="tooltip" data-placement="left" title="Edit">
